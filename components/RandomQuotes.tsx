  ...
  return (
    <section id="quotes" className="w-full my-6">
      <button
        ...
        className="relative w-full overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/80 via-zinc-950 to-black px-5 py-7 text-left transition-colors hover:border-zinc-700 sm:px-8 sm:py-8"
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="max-w-3xl text-sm sm:text-base text-zinc-200 font-mono leading-relaxed text-pretty">
            {quote?.quote}
          </p>
